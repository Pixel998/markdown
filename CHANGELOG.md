...
## [8.0.0](https://github.com/Pixel998/markdown/compare/v7.2.0...v8.0.0) (2025-09-16)


### ⚠ BREAKING CHANGES

* move certain types to import them from `@eslint/markdown/types` ([#446](https://github.com/Pixel998/markdown/issues/446))
* set no-missing-link-fragments default ignoreCase to true ([#447](https://github.com/Pixel998/markdown/issues/447))
* remove rollup and extraneous types ([#383](https://github.com/Pixel998/markdown/issues/383))
* Rename to @eslint/markdown ([#265](https://github.com/Pixel998/markdown/issues/265))
* Convert to ESM ([#259](https://github.com/Pixel998/markdown/issues/259))
* map known code block languages to respective file extensions ([#246](https://github.com/Pixel998/markdown/issues/246))
* drop eslint < 8 & Node.js < 18 ([#238](https://github.com/Pixel998/markdown/issues/238))
* Switch to flat config ([#232](https://github.com/Pixel998/markdown/issues/232))
* drop node v8 and v10 ([#203](https://github.com/Pixel998/markdown/issues/203))

### Features

* add `meta` property ([#233](https://github.com/Pixel998/markdown/issues/233)) ([eedda96](https://github.com/Pixel998/markdown/commit/eedda967069a665b800fcf95b985424e50c77df6))
* add `no-missing-atx-heading-space` rule ([#371](https://github.com/Pixel998/markdown/issues/371)) ([84c87c4](https://github.com/Pixel998/markdown/commit/84c87c407bdfb64694581afb26066a5b233bd59c))
* add allowDefinitions & allowFootnoteDefinitions opts to no-empty-definitions ([#455](https://github.com/Pixel998/markdown/issues/455)) ([e09eba6](https://github.com/Pixel998/markdown/commit/e09eba6b0e89148af1dd2b9ae4706bbf8e5f6b0d))
* add allowedIgnoreCase option to no-html ([#500](https://github.com/Pixel998/markdown/issues/500)) ([06ac53d](https://github.com/Pixel998/markdown/commit/06ac53d050f0b4e0a407d427790d85db4a1f0462))
* add allowLabels option to no-missing-label-refs ([#513](https://github.com/Pixel998/markdown/issues/513)) ([f6d6b76](https://github.com/Pixel998/markdown/commit/f6d6b767a97f2b648164503b5de0f105a31935d6))
* add checkClosedHeadings option to no-missing-atx-heading-space ([#452](https://github.com/Pixel998/markdown/issues/452)) ([a9675aa](https://github.com/Pixel998/markdown/commit/a9675aa81e8bf79f2e865f433b961a201f82eac1))
* add checkFootnoteDefinitions option to no-empty-definitions ([#442](https://github.com/Pixel998/markdown/issues/442)) ([4d504e5](https://github.com/Pixel998/markdown/commit/4d504e523d7c63820aaaa7b4d2dd9de7edb50960))
* add checkMissingCells option to table-column-count ([#434](https://github.com/Pixel998/markdown/issues/434)) ([bf3f39b](https://github.com/Pixel998/markdown/commit/bf3f39be366f6dec6ad6a8d26751c06d04988e3f))
* add checkSiblingsOnly option to no-duplicate-headings rule ([#393](https://github.com/Pixel998/markdown/issues/393)) ([2512729](https://github.com/Pixel998/markdown/commit/25127297f0ee8f63b860a42538cec9612e154b0b))
* Add disable comment support ([#281](https://github.com/Pixel998/markdown/issues/281)) ([acdbd08](https://github.com/Pixel998/markdown/commit/acdbd08102a60d9521cb9c2c29917cf4b0a27e14))
* add frontmatterTitle option to heading-increment ([#454](https://github.com/Pixel998/markdown/issues/454)) ([614ef3e](https://github.com/Pixel998/markdown/commit/614ef3e0bf539655170f202467119fbbbf8963f6))
* add JSON frontmatter support ([#411](https://github.com/Pixel998/markdown/issues/411)) ([8b77e69](https://github.com/Pixel998/markdown/commit/8b77e6993ed045482a966470d906d9636b1b4abc))
* Add Markdown languages ([#268](https://github.com/Pixel998/markdown/issues/268)) ([d79c42b](https://github.com/Pixel998/markdown/commit/d79c42bcb1a8f495b21733c25c8b70e881a7ebf9))
* add missing `mdast` types to `MarkdownRuleVisitor` ([#334](https://github.com/Pixel998/markdown/issues/334)) ([fc8ba03](https://github.com/Pixel998/markdown/commit/fc8ba0314696c2f22233a9870360e2e9a5799ccc))
* add name to flat configs ([#256](https://github.com/Pixel998/markdown/issues/256)) ([001d51e](https://github.com/Pixel998/markdown/commit/001d51e9a66bea80f0c971f05a9cf4e1126dfaa8))
* add no-bare-urls rule ([#418](https://github.com/Pixel998/markdown/issues/418)) ([5149927](https://github.com/Pixel998/markdown/commit/514992754650499cf1c8d7e4f56a1e7666a3d384))
* add no-empty-definitions rule ([#364](https://github.com/Pixel998/markdown/issues/364)) ([cb5a956](https://github.com/Pixel998/markdown/commit/cb5a95666524e3c26650371bfdcd59e15cae4053))
* add no-missing-link-fragments rule ([#380](https://github.com/Pixel998/markdown/issues/380)) ([70e7dac](https://github.com/Pixel998/markdown/commit/70e7dacab279579c57396589da798d7e2e3a0a50))
* add no-multiple-h1 rule ([#377](https://github.com/Pixel998/markdown/issues/377)) ([d7c88e8](https://github.com/Pixel998/markdown/commit/d7c88e898b251cb1bf9eb3b19075b6b6c4a4d255))
* add no-reference-like-urls rule ([#433](https://github.com/Pixel998/markdown/issues/433)) ([65251ec](https://github.com/Pixel998/markdown/commit/65251ec12b617f62357fe9239b60200973e5d2b7))
* add no-reversed-media-syntax rule ([#398](https://github.com/Pixel998/markdown/issues/398)) ([ae547ab](https://github.com/Pixel998/markdown/commit/ae547ab935307f5bea60ea3d0e1ccefdc8fc43f6))
* add no-space-in-emphasis rule ([#403](https://github.com/Pixel998/markdown/issues/403)) ([e4b8de4](https://github.com/Pixel998/markdown/commit/e4b8de4494820b5a61beec6564cb4c5f9d72cede))
* add require-alt-text rule ([#368](https://github.com/Pixel998/markdown/issues/368)) ([32d8cbd](https://github.com/Pixel998/markdown/commit/32d8cbd8b6d2d121225b5291c2f9a0ea6c2ccd00))
* Add type checking and type definitions ([#266](https://github.com/Pixel998/markdown/issues/266)) ([0503748](https://github.com/Pixel998/markdown/commit/0503748497e623842b8c78b140b766a086ee2ce7))
* added new rule `table-column-count` ([#392](https://github.com/Pixel998/markdown/issues/392)) ([c685139](https://github.com/Pixel998/markdown/commit/c68513942c0735fc7fbae7edbc95a36093a30ee0))
* allow specifying filename in block meta ([#318](https://github.com/Pixel998/markdown/issues/318)) ([7075f00](https://github.com/Pixel998/markdown/commit/7075f009d435e6d940deefe903ba9848964e001c))
* Convert to ESM ([#259](https://github.com/Pixel998/markdown/issues/259)) ([e0da221](https://github.com/Pixel998/markdown/commit/e0da2214cc06fd441def1844135f3c9fef74e940))
* create `no-duplicate-definitions` ([#360](https://github.com/Pixel998/markdown/issues/360)) ([18c7d77](https://github.com/Pixel998/markdown/commit/18c7d776c768b901a0049b6e9bd7cf9e060ae835))
* create `no-empty-images` ([#357](https://github.com/Pixel998/markdown/issues/357)) ([23e4ff0](https://github.com/Pixel998/markdown/commit/23e4ff0d7be9e10ce017357cb5f8e15276c6c404))
* create `no-unused-definitions` rule ([#425](https://github.com/Pixel998/markdown/issues/425)) ([6b43333](https://github.com/Pixel998/markdown/commit/6b43333e54a7685211252ae994091a066520861b))
* Create type definitions for rules ([#324](https://github.com/Pixel998/markdown/issues/324)) ([5f11a3d](https://github.com/Pixel998/markdown/commit/5f11a3d071103f4103310fc6916508eb7cb76def))
* drop eslint &lt; 8 & Node.js &lt; 18 ([#238](https://github.com/Pixel998/markdown/issues/238)) ([f14f6a5](https://github.com/Pixel998/markdown/commit/f14f6a58ffe65cee8c31beb6d8ff8bcc1ae81383))
* drop node v8 and v10 ([#203](https://github.com/Pixel998/markdown/issues/203)) ([071fa66](https://github.com/Pixel998/markdown/commit/071fa661875e4bd88a91dcd39eee9276bf3f2b0a))
* export `MarkdownRuleDefinition` type ([#333](https://github.com/Pixel998/markdown/issues/333)) ([13dfd5e](https://github.com/Pixel998/markdown/commit/13dfd5ec279d1db3cbd1ef2b6bf5d00799371090))
* export types from main entry point ([#520](https://github.com/Pixel998/markdown/issues/520)) ([915837c](https://github.com/Pixel998/markdown/commit/915837c6cf72c7ca0c7d7b2f1708698d65e8dc14))
* Expose identifiers in messages for no-duplicate-definitions ([#506](https://github.com/Pixel998/markdown/issues/506)) ([9f54c1b](https://github.com/Pixel998/markdown/commit/9f54c1b65549b584cbad686f5d488d803a4e3540))
* expose identifiers in messages for no-empty-definitions ([#507](https://github.com/Pixel998/markdown/issues/507)) ([738f366](https://github.com/Pixel998/markdown/commit/738f3660e8f3df250028963547aad840a3145e20))
* fix false positives and negatives for consecutive backslashes ([#490](https://github.com/Pixel998/markdown/issues/490)) ([3067607](https://github.com/Pixel998/markdown/commit/3067607753d4ed75b10ca394557c34e502dbacf9))
* JSR package ([#271](https://github.com/Pixel998/markdown/issues/271)) ([7040a2e](https://github.com/Pixel998/markdown/commit/7040a2e3b9b4e1a49cf4b86dbe1ce6c52535d55e))
* map known code block languages to respective file extensions ([#246](https://github.com/Pixel998/markdown/issues/246)) ([096cff4](https://github.com/Pixel998/markdown/commit/096cff4094dc9118a3538980ee56bfb8c5cb03d4))
* Rename to @eslint/markdown ([#265](https://github.com/Pixel998/markdown/issues/265)) ([e0b5457](https://github.com/Pixel998/markdown/commit/e0b545708c051e605b438f9cddde8dad3ec24c6e))
* set no-missing-link-fragments default ignoreCase to true ([#447](https://github.com/Pixel998/markdown/issues/447)) ([925191e](https://github.com/Pixel998/markdown/commit/925191e20282b53d95a6d54a9fea7a78df893242))
* support `eslint` config comments ([#332](https://github.com/Pixel998/markdown/issues/332)) ([f697540](https://github.com/Pixel998/markdown/commit/f6975405df4899002053988b2771066a3f2426bc))
* support front matter ([#328](https://github.com/Pixel998/markdown/issues/328)) ([35a979c](https://github.com/Pixel998/markdown/commit/35a979c16a0762024ba7150439a7628f56b76a51))
* Switch to flat config ([#232](https://github.com/Pixel998/markdown/issues/232)) ([7a27eef](https://github.com/Pixel998/markdown/commit/7a27eef394dbc06f24b16d926946d60accb2d4c7))
* update `no-multiple-h1` rule to recognize JSON frontmatter ([#413](https://github.com/Pixel998/markdown/issues/413)) ([33dda18](https://github.com/Pixel998/markdown/commit/33dda184d2919ea33ba850a018b6972429aeb5c6))
* verify identifier data in no-empty-definitions ([#499](https://github.com/Pixel998/markdown/issues/499)) ([738f366](https://github.com/Pixel998/markdown/commit/738f3660e8f3df250028963547aad840a3145e20))


### Bug Fixes

* `exactOptionalPropertyTypes` causes type errors when using plugins ([#524](https://github.com/Pixel998/markdown/issues/524)) ([15014a4](https://github.com/Pixel998/markdown/commit/15014a4ad0ec5db1e24ae72a09c1e705c756f006))
* `message.line` could be `undefined` ([#191](https://github.com/Pixel998/markdown/issues/191)) ([3a40160](https://github.com/Pixel998/markdown/commit/3a401606cb2ac4dae6b95720799ed1c611af32d0))
* `no-invalid-label-refs` do not report correct position ([#366](https://github.com/Pixel998/markdown/issues/366)) ([ed01747](https://github.com/Pixel998/markdown/commit/ed01747d29eed0b1379211bb1d97d3dbff3389c8))
* `no-missing-label-refs` rule does not respect escaping ([#348](https://github.com/Pixel998/markdown/issues/348)) ([cb6b437](https://github.com/Pixel998/markdown/commit/cb6b4376e94f2f89a100352d01857ad08deff652))
* `overrides` general docs and Atom linter-eslint tips (fixes [#109](https://github.com/Pixel998/markdown/issues/109)) ([#111](https://github.com/Pixel998/markdown/issues/111)) ([2a8482e](https://github.com/Pixel998/markdown/commit/2a8482e8e39da2ab4a1d8aeb7459f26a8377905d))
* Account for BOM in the processor ([#282](https://github.com/Pixel998/markdown/issues/282)) ([01bceae](https://github.com/Pixel998/markdown/commit/01bceae60fd229fbbaddf6bddffb9ec3933e8605))
* add type tests ([#305](https://github.com/Pixel998/markdown/issues/305)) ([ea60127](https://github.com/Pixel998/markdown/commit/ea60127142ea335fe2ea7d70205ce6208df26bbc))
* Add unicode-bom to unsatisfiable rules (refs [#75](https://github.com/Pixel998/markdown/issues/75)) ([#84](https://github.com/Pixel998/markdown/issues/84)) ([e34acc6](https://github.com/Pixel998/markdown/commit/e34acc60c2867889ba4d16a2deecc2cbd03e351b))
* adjust suggestion fix ranges in processor ([#309](https://github.com/Pixel998/markdown/issues/309)) ([f164e66](https://github.com/Pixel998/markdown/commit/f164e66016821f2d35a22851552d43f0c0c33a73))
* allow any type for `meta.docs.recommended` in custom rules ([#502](https://github.com/Pixel998/markdown/issues/502)) ([604a4b9](https://github.com/Pixel998/markdown/commit/604a4b97771c3c1c4b45b9999c18dc52bcd8b332))
* Allowing eslint-plugin-prettier to work (fixes [#101](https://github.com/Pixel998/markdown/issues/101)) ([#107](https://github.com/Pixel998/markdown/issues/107)) ([a2f4492](https://github.com/Pixel998/markdown/commit/a2f44927bda799a699bea3fbee0bfb8f6dd8ce14))
* Apply base indent to multiple line breaks (fixes [#127](https://github.com/Pixel998/markdown/issues/127)) ([#128](https://github.com/Pixel998/markdown/issues/128)) ([5640ea6](https://github.com/Pixel998/markdown/commit/5640ea65730abab5c9c97d77b5708f3499ec62f3))
* bump `plugin-kit` to latest to resolve security vulnerabilities ([#485](https://github.com/Pixel998/markdown/issues/485)) ([c5398ca](https://github.com/Pixel998/markdown/commit/c5398caac221daa147a2993cc945e42e374a6c5d))
* case-insensitive attribute checks in `no-missing-link-fragment` ([#465](https://github.com/Pixel998/markdown/issues/465)) ([094a59d](https://github.com/Pixel998/markdown/commit/094a59d13b294f62c45693f41e921e08d15f0ccb))
* case-insensitive checks for HTML attributes in `no-missing-link-fragment` ([094a59d](https://github.com/Pixel998/markdown/commit/094a59d13b294f62c45693f41e921e08d15f0ccb))
* check upper bounds of message line numbers for code blocks ([#247](https://github.com/Pixel998/markdown/issues/247)) ([00adccb](https://github.com/Pixel998/markdown/commit/00adccb49ed74e6b6ce43bc221a93d7c6782a83c))
* correct `exports` field in package.json ([#279](https://github.com/Pixel998/markdown/issues/279)) ([8e40d30](https://github.com/Pixel998/markdown/commit/8e40d308dba0fdcb445cbebf56a161db16bf5806))
* detect errors after comments in no-multiple-h1 and require-alt-text ([#468](https://github.com/Pixel998/markdown/issues/468)) ([c9de444](https://github.com/Pixel998/markdown/commit/c9de44424f38d01ecc5a71e95558d2512f8a58ca))
* Don't require message end locations (fixes [#112](https://github.com/Pixel998/markdown/issues/112)) ([#154](https://github.com/Pixel998/markdown/issues/154)) ([0311640](https://github.com/Pixel998/markdown/commit/03116401ae7be0c86b5a48d22aacd94df387a5df))
* Emit correct endLine numbers ([#88](https://github.com/Pixel998/markdown/issues/88)) ([dff8e9c](https://github.com/Pixel998/markdown/commit/dff8e9c7f334af8a68a6c8a3671ffc01c3bdafbb))
* enhance fenced code language rule to support tilde as a delimiter ([#344](https://github.com/Pixel998/markdown/issues/344)) ([852645e](https://github.com/Pixel998/markdown/commit/852645ee070c5c85a45c740a0925fb70768cc840))
* ensure ATX headings follow spec for space after hash characters ([#421](https://github.com/Pixel998/markdown/issues/421)) ([bab9670](https://github.com/Pixel998/markdown/commit/bab96707428ee694888cfaa3f22ae8823a7880e0))
* Exclude eol-last from output (fixes [#48](https://github.com/Pixel998/markdown/issues/48)) ([abab043](https://github.com/Pixel998/markdown/commit/abab043f054e0b7f838615875b579c81d6aa288b))
* false negatives and positives in `no-reversed-media-syntax` ([#473](https://github.com/Pixel998/markdown/issues/473)) ([c7a4d64](https://github.com/Pixel998/markdown/commit/c7a4d648a0ae810a55acd4f0b78bd57e8145a513))
* fenced-code-language highlights only relevant parts ([#487](https://github.com/Pixel998/markdown/issues/487)) ([bb48ae2](https://github.com/Pixel998/markdown/commit/bb48ae2592240e53a35cd705691636b2ceeefd12))
* handle consecutive backslashes in `no-reference-like-urls` ([#523](https://github.com/Pixel998/markdown/issues/523)) ([762712d](https://github.com/Pixel998/markdown/commit/762712d699f7962cecadfd906486f681c175ba9a))
* handle multiline setext headings in `no-duplicate-headings` ([#469](https://github.com/Pixel998/markdown/issues/469)) ([99beea6](https://github.com/Pixel998/markdown/commit/99beea674271a5a98ba889fd00d96c3ad282f7e3))
* handle URL-encoded link fragments in no-missing-link-fragments rule ([#437](https://github.com/Pixel998/markdown/issues/437)) ([76685c5](https://github.com/Pixel998/markdown/commit/76685c58eab498bf4b4b2661d9fb303f37f18303))
* Ignore anything after space in code fence's language (fixes [#98](https://github.com/Pixel998/markdown/issues/98)) ([#99](https://github.com/Pixel998/markdown/issues/99)) ([a5d0cce](https://github.com/Pixel998/markdown/commit/a5d0ccec6f14f4808a535c0f06273d1e9892be15))
* Ignore words in info string after syntax (fixes [#166](https://github.com/Pixel998/markdown/issues/166)) ([#167](https://github.com/Pixel998/markdown/issues/167)) ([23ac2b9](https://github.com/Pixel998/markdown/commit/23ac2b95b1c2666baf422c24f5b73607d315a700))
* improve HTML id/name regex for unquoted values and spaces ([#480](https://github.com/Pixel998/markdown/issues/480)) ([6c35261](https://github.com/Pixel998/markdown/commit/6c35261bb1ed925b43537a40909b04225668d5cf))
* improve no-html rule's tag location reporting ([#491](https://github.com/Pixel998/markdown/issues/491)) ([5e6e94e](https://github.com/Pixel998/markdown/commit/5e6e94e0fc030ca4987f0f8067e78a3ec93f65a9))
* Indent multiline fixes (fixes [#120](https://github.com/Pixel998/markdown/issues/120)) ([#124](https://github.com/Pixel998/markdown/issues/124)) ([fb0b5a3](https://github.com/Pixel998/markdown/commit/fb0b5a3fc36ad362556cafc49929f49e3b4bc6b0))
* make `meta` property optional in `Block` type ([#461](https://github.com/Pixel998/markdown/issues/461)) ([15c93a6](https://github.com/Pixel998/markdown/commit/15c93a69b970db3bac145ad0be80d32dfd9f4285))
* More reliable comment attachment (fixes [#76](https://github.com/Pixel998/markdown/issues/76)) ([#177](https://github.com/Pixel998/markdown/issues/177)) ([79be776](https://github.com/Pixel998/markdown/commit/79be776331cf2bb4db2f265ee6cf7260e90e3d5e))
* move certain types to import them from `@eslint/markdown/types` ([#446](https://github.com/Pixel998/markdown/issues/446)) ([0dc6220](https://github.com/Pixel998/markdown/commit/0dc62200fc476e7e6b94823326edd23c2e119c16))
* no-*-definitions rules show original label and identifier ([#515](https://github.com/Pixel998/markdown/issues/515)) ([f80a9e1](https://github.com/Pixel998/markdown/commit/f80a9e1d6b505e42491f49fc6ac36eeacd3bdbab))
* no-missing-label-refs should not crash on undefined labels ([#290](https://github.com/Pixel998/markdown/issues/290)) ([ac1bc1c](https://github.com/Pixel998/markdown/commit/ac1bc1c2615184128ecad07e44079213b4ecc7da))
* no-reversed-media-syntax add missing offset for code spans ([#460](https://github.com/Pixel998/markdown/issues/460)) ([af7736c](https://github.com/Pixel998/markdown/commit/af7736c51d2ad6d065d12b5b92ff01aff8d58a4a))
* normalize definition identifiers in no-*-definitions rules ([#488](https://github.com/Pixel998/markdown/issues/488)) ([b248383](https://github.com/Pixel998/markdown/commit/b24838360407dd32ceacc9fa8af8a926ce9f7144))
* npm prepare script on Windows (refs [#166](https://github.com/Pixel998/markdown/issues/166)) ([#168](https://github.com/Pixel998/markdown/issues/168)) ([1dd7089](https://github.com/Pixel998/markdown/commit/1dd70890b92827a5fbd3a86a62c3f2bc30389340))
* overrides pattern for virtual filenames in recommended config ([#169](https://github.com/Pixel998/markdown/issues/169)) ([f6a3fad](https://github.com/Pixel998/markdown/commit/f6a3fada43aaeb613aaf9168dfd06a53b9db0ab4))
* potential super-linear regular expressions ([#463](https://github.com/Pixel998/markdown/issues/463)) ([bc82567](https://github.com/Pixel998/markdown/commit/bc82567458f8fc41b36cbcb2c67aac746078e044))
* Remove peer dependency ([#284](https://github.com/Pixel998/markdown/issues/284)) ([2cf3c6b](https://github.com/Pixel998/markdown/commit/2cf3c6bb7a3572e868bbb271c56763cb0bc9172f))
* remove rollup and extraneous types ([#383](https://github.com/Pixel998/markdown/issues/383)) ([e7ccd2e](https://github.com/Pixel998/markdown/commit/e7ccd2e3e58757fa1a1d616fda285e957880c36d))
* remove unused types from `types.ts` ([#462](https://github.com/Pixel998/markdown/issues/462)) ([466f80e](https://github.com/Pixel998/markdown/commit/466f80e1b66e4894853ed26e7475fdab944a33ce))
* replace `IMarkdownSourceCode` with `MarkdownSourceCode` ([#336](https://github.com/Pixel998/markdown/issues/336)) ([ec2846b](https://github.com/Pixel998/markdown/commit/ec2846be8d0e0a3c216ea471eda62a1ce1a990a7))
* skip HTML nodes in heading slugs for no-missing-link-fragments ([#445](https://github.com/Pixel998/markdown/issues/445)) ([e4dcf6a](https://github.com/Pixel998/markdown/commit/e4dcf6a27e6761964293258c37c925029fdfaf22))
* Support autofix at the very start of blocks (fixes [#117](https://github.com/Pixel998/markdown/issues/117)) ([#119](https://github.com/Pixel998/markdown/issues/119)) ([dc90961](https://github.com/Pixel998/markdown/commit/dc909618aa8f39e84279f5bdeb4a888d56d919b1))
* Support globals (fixes [#79](https://github.com/Pixel998/markdown/issues/79)) ([#81](https://github.com/Pixel998/markdown/issues/81)) ([7c19f8b](https://github.com/Pixel998/markdown/commit/7c19f8bdd5db610ea4c65208f5a37fea684a8d7b))
* update `no-duplicate-headings` to align with CommonMark spec ([#438](https://github.com/Pixel998/markdown/issues/438)) ([2bc0a38](https://github.com/Pixel998/markdown/commit/2bc0a38a2e5558f06f2f015012901a1741d35338))
* update `require-alt-text` rule to ignore commented images ([#385](https://github.com/Pixel998/markdown/issues/385)) ([b2fc801](https://github.com/Pixel998/markdown/commit/b2fc801727eb7ed554e74a9cf690c4777b66ff72))
* Update markdown-language.js ([#314](https://github.com/Pixel998/markdown/issues/314)) ([10e8535](https://github.com/Pixel998/markdown/commit/10e8535f4f58b2d08581505d6a6c1600d941cf96))
* use blocksCache instead of single blocks instance (fixes [#181](https://github.com/Pixel998/markdown/issues/181)) ([#183](https://github.com/Pixel998/markdown/issues/183)) ([d23d5f7](https://github.com/Pixel998/markdown/commit/d23d5f739943d136669aac945ef25528f31cd7db))
* wrong location reporting in `fenced-code-language` ([#518](https://github.com/Pixel998/markdown/issues/518)) ([c532194](https://github.com/Pixel998/markdown/commit/c532194e1c7e0fab4bb9fc9d683fc61d5a1a91c5))
